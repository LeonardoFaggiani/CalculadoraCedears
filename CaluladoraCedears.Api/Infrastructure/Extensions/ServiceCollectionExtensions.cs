...
using CaluladoraCedears.Api.Infrastructure.HealthChecks;
using Microsoft.AspNetCore.Diagnostics.HealthChecks;
using CaluladoraCedears.Api.CrossCutting.Bus;
using CaluladoraCedears.Api.Domian.Events;
using CaluladoraCedears.Api.Infrastructure.Data;
using CaluladoraCedears.Api.Infrastructure.Exceptions.Builder;
using CaluladoraCedears.Api.Infrastructure.Filters;
using CaluladoraCedears.Api.Infrastructure.Repositories;
using CaluladoraCedears.Api.Infrastructure.Repositories.Base;

namespace CaluladoraCedears.Api.Infrastructure.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddConnectionString(this IServiceCollection services)
        {
            ...
            services.AddDbContext<CaluladoraCedearsContext>(options => { options.UseInMemoryDatabase("caluladoracedearsApiBD"); }, ServiceLifetime.Transient);
            //services.AddDbContext<CaluladoraCedearsContext>(options => { options.UseSqlServer("your-connection-string"); }, ServiceLifetime.Transient);
